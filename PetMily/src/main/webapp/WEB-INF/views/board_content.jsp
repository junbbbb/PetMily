...
<form action="modify" enctype="multipart/form-data" method="post">
  <input type="hidden" name="seqno" value="${content_view.seqno}">
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="row justify-content-center ">
				<div class="col-4 mb-3 gy-4">
					<label for="exampleFormControlInput1" class="form-label">게시물 번호
					</label> 
					<h4>${content_view.seqno} </h4>
				</div>
				<div class="col-2"></div>
			</div>
		</div>
		...
		<!-- 삭제 -->
		<div align="center">
			<a href="delete?seqno=${content_view.seqno}">삭제</a>
		</div> 
		
		<!-- 수정 버튼 -->
		<div class="row justify-content-center my-5 text-center">
			<div class="col-4">
				<input class="btn btn-warning w-100" type="submit" value="수정" >
			</div>
		</div>
	</div>
</form>
